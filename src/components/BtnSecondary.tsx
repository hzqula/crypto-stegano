...
const BtnSecondary: React.FC<BtnProps> = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`inline-block px-3 font-text text-sm font-semibold relative top-0 left-0 py-2 transition-all duration-100 border-2 ${borderColor} bg-background ${textColor}
